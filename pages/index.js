            ...
            <div data-thq="thq-mobile-menu" className="home-mobile-menu">
              ...
              >
                ...
                <nav
                  ...
                  className="home-nav1"
                >
                  <span className="home-text">AIRDROP</span>
                  <a href="#roadmap" className="home-link01">
                    ROADMAP
                  </a>
                  <a href="#tokenomics" className="home-link02">
                    TOKENOMICS
                  </a>
                </nav>
              </div>
              ...
              <div className="home-links">
                ...
                <div className="home-column1">
                  ...
                  <div className="home-list1">
                    ...
                    <Link href="/">
                      <a className="home-link10">DISCORD</a>
                    </Link>
                  </div>
                </div>
              </div>
